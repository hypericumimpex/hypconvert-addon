		...
		<form method="post" class="cp-settings-form">
			<div class="debug-section cp-access-roles">
				<table class="cp-postbox-table form-table">
					<tr class="cp-settings-row">
						...
						<td>
							<select name="cp-ga-auth-type" id="cp-ga-auth-type">
								...
								<option value="gtag" <?php selected( $cp_ga_auth_type, 'gtag' ); ?>><?php _e( 'Already added Global Site Tag (gtag) code', 'convertpro-addon' ); ?></option>
					...
					<tr class="cp-settings-row">
						<th scope="row">
							<label for="cp-ga-anonymous-ip"><?php _e( 'Anonymize IP for event tracking', 'convertpro-addon' ); ?>
							</label>
						</th>
						<td>
							<?php
							...
							<span class="help-link" style="margin-left: 15px;"><a target='_blank' rel="noopener" href='https://support.google.com/analytics/answer/2763052?hl=en'><?php _e( 'Learn more about IP Anonymization in Analytics.', 'convertpro-addon' ); ?></a>
							</span>
						</td>
					</tr>
					<tr class="cp-settings-row" data-dep-element='cp-ga-auth-type' data-dep-val='gtm-code'>
						...
						<td>
							<span>
								<?php
								$doc_link = 'https://www.convertpro.net/docs/setup-convert-pro-events-google-tag-manager/';
								/* translators: %s Link */
